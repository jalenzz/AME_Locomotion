...
GO2_FINETUNE_ROUGH_TERRAINS_CFG = TerrainGeneratorCfg(
    size=(8.0, 8.0),
    border_width=50.0,
    num_rows=10,
    num_cols=20,
    ...
    sub_terrains={
        ...
        "stakes1": terrain_gen.HfDoubleColumnStakesTerrainCfg(
            proportion=0.1, stake_height_max=0.03, stake_side_range=(0.3, 0.45), stake_gap_range=(0.05, 0.18),
            column_gap_range=(0.05, 0.12), column_jitter=0.0, holes_depth=-2.0, platform_width=2.0, border_width=0.25,
        ),
        "stakes2": terrain_gen.HfAlternateColumnStakesTerrainCfg(
            proportion=0.2, stake_height_max=0.03, stake_side_range=(0.3, 0.45), stake_gap_range=(0.03, 0.12),
            column_gap_range=(0.0, 0.12), column_jitter=0.0, holes_depth=-2.0, platform_width=2.0, border_width=0.25,
        ),
        "stakes3": terrain_gen.HfAlternateColumnStakesTerrainCfg(
            proportion=0.2, stake_height_max=0.03, stake_side_range=(0.28, 0.42), stake_gap_range=(0.05, 0.18),
            column_gap_range=(0.15, 0.25), column_jitter=0.0, holes_depth=-2.0, platform_width=2.0, border_width=0.25,
        ),
        "hf_gaps": terrain_gen.HfConcentricGapTerrainCfg(
            proportion=0.1, gap_width_range=(0.1, 0.35), platform_width=2.0, border_width=0.25, gap_depth=-2.0,
            ground_width_range=(0.5, 0.5), ground_height_max=0.03,
        ),
        "stonebridge": terrain_gen.HfStonesBridgeTerrainCfg(
            proportion=0.1, platform_width=2.0, border_width=0.25, holes_depth=-2.0,
            stone_height_max=0.03, stone_width_range=(0.35, 0.5), stone_distance_range=(0.12, 0.3),
            stone_length_range=(0.7, 1.1), stone_lateral_distance_range=(0.0, 0.0),
        ),
        "rails": terrain_gen.MeshRailsTerrainCfg(
            proportion=0.1, rail_height_range=(0.05, 0.18), rail_thickness_range=(0.15, 0.3), platform_width=2.0,
        ),
    },
)
"""Fine-tuning terrains tailored for the smaller Unitree Go2."""
